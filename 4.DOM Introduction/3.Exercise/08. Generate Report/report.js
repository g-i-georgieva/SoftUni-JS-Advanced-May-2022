function generateReport() {
    let checkedCheckboxesElement = document.querySelectorAll(
      `thead tr th input:checked`
    );
    let keys = [];
    ...
    let outputElement = document.querySelector("textarea#output");
